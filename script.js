...
class KanbanColumn {
    constructor(titulo, cor) {
        ...
        // ADICIONA A LÓGICA DE DRAG-AND-DROP À COLUNA
...
class KanbanCard {
    constructor(dados) {
        ...
        // Adiciona um ID único para o card
    ...
    createElement() {
        ...
        // ADICIONA O ID COMO ATRIBUTO DE DADOS
        kanban_card.setAttribute("data-id", this.id);

        // ADICIONA A LÓGICA DE DRAGSTART E DRAGEND AO CARD
        kanban_card.addEventListener("dragstart", e => {
            e.dataTransfer.setData("text/plain", this.id);
            kanban_card.classList.add("dragging");
        });

        kanban_card.addEventListener("dragend", () => {
            kanban_card.classList.remove("dragging");
        });
